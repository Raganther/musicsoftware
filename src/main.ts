...
function enterJam() {
  ...
  p.textContent = [
    ...
    '',
    'key row        retunes every linked channel to',
    '               one root + scale; each keeps its',
    '               own register. Lands on the bar.',
    '               Click the lit key to release.',
    'key chip       per strip: unlink to let that',
    '               channel keep its own key',
    'morph          scene recall glides parameters',
    '               over ½–4 bars instead of jumping',
    '',
    '1-4            recall scene',
    'shift+1-4      store scene (params, mix, key, bpm)',
